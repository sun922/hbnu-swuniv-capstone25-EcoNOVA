...
- ### 필요성
  ...
  - 특히 초지공정, 건조공정은 설비 간 상호작용과 공정 변동성이 커 안정적인 품질 유지와 에너지 절감이 어려움.
  - 최근 산업계에서는 이러한 한계를 극복하기 위해 스마트 팩토리 전환을 가속화하고 있으며, 특히 디지털 트윈이 주목받고 있음.
  - 제지 산업에서도 디지털 트윈을 활용한 공정 시뮬레이션과 데이터 기반 최적화가 에너지 효율과 품질 향상에 필수적임. 
- ### 기존 해결책의 문제점
  - 기존 최적화 연구는 이론적 접근에 머물러 현장 적용성과 실시간 대응력이 부족함.  
  - 공정 데이터의 분산 및 관리 미흡으로 인해 경험 의존적 운전이 지속되고, 객관적 분석과 의사결정이 어려움.
  - 이러한 구조에서는 실시간 대응 체계를 갖추기도 힘들며, 생산성, 품질, 에너지 사이의 균형 제어가 불가능한 한계가 존재함.
